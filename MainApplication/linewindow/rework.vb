Public Class rework
    Private Sub rework_Load(sender As Object, e As EventArgs) Handles MyBase.Load
...
nextline:
    ...
    Private Sub reworksave()
        ...
        Else
            rework_save(txt_pcbsno.Text, txt_product_code.Text, txt_product_name.Text, txt_lot_no.Text, txt_line_no.Text, Stage_aoi, cmb_status.SelectedItem, remarks)
        End If
    End Sub
