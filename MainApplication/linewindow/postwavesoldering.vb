Public Class postwavesoldering


    Private Sub postwavesoldering_Load(sender As Object, e As EventArgs) Handles MyBase.Load
...
nextline:
    ...
    Private Sub btn_cancel_Click(sender As Object, e As EventArgs) Handles btn_cancel.Click
        result = check_serialnumber_prewave(txt_pcbsno.Text)
        If result = True Then
            update_postwave(txt_pcbsno.Text)
        Else
            MsgBox("PREWAVE Stage not Passed", vbCritical, "Error")
        End If
    End Sub
    Private Sub postwavesave()
        ...
        Else
            result = check_serialnumber_prewave(txt_pcbsno.Text)
            If result = True Then
                postwave_save(txt_pcbsno.Text, txt_product_code.Text, txt_product_name.Text, txt_lot_no.Text, txt_line_no.Text, Stage_aoi, cmb_status.SelectedItem, remarks)
            Else
                MsgBox("PREWAVE Stage not Passed", vbCritical, "Error")
            End If
        End If
