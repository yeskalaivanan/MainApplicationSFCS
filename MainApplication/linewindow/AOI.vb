...
Public Class AOI
    Private Sub AOI_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        mainform.ts_message.Text = "AOI Form Opened"
    End Sub
...
nextline:
    ...
    Private Sub aoisave()
        ...
        Else
            result = check_serialnumber_lasermarking(txt_pcbsno.Text)
            If result = True Then
                aoi_save(txt_pcbsno.Text, txt_product_code.Text, txt_product_name.Text, txt_lot_no.Text, txt_line_no.Text, Stage_aoi, cmb_status.SelectedItem, remarks)
            Else
                MsgBox("LaserMarking Stage not Passed", vbCritical, "Error")
            End If
        End If
    End Sub

    Private Sub btn_cancel_Click(sender As Object, e As EventArgs) Handles btn_cancel.Click
        update_aoi(txt_pcbsno.Text)
    End Sub
